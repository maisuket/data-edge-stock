...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Lista paginada.', type: page_dto_1.PageDto }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Proibido alterar outro usuário.' }),
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Email ou Username já existem.' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Proibido excluir a si mesmo.' }),
    __param(0, (0, common_1.Param)('id')),
